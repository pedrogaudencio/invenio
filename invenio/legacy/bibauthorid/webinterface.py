...
from invenio.config import CFG_BASE_URL, CFG_SITE_LANG, CFG_SITE_URL, CFG_SITE_NAME, CFG_INSPIRE_SITE, CFG_SITE_SECURE_URL
...
from invenio.utils.url import redirect_to_url, get_canonical_and_alternates_urls
from invenio.legacy.webuser import  (getUid,
                                     ...
                                     get_uid_from_email,
                                     isGuestUser)
from invenio.modules.access.control import acc_get_user_roles
...
from invenio.legacy.bibauthorid.general_utils import get_title_of_doi, get_title_of_arxiv_pubid, is_valid_orcid
...
from invenio.legacy.webauthorprofile.interface import is_valid_canonical_id, get_person_id_from_canonical_id, \
