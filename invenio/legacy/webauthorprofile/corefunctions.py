...
from invenio.legacy.webauthorprofile.config import serialize, deserialize
from invenio.legacy.webauthorprofile.config import CFG_BIBRANK_SHOW_DOWNLOAD_STATS, \
...
from invenio.legacy.webauthorprofile.dbapi import get_cached_element, precache_element, cache_element, \
