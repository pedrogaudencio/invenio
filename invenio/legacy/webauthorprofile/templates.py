...
from invenio.legacy.webauthorprofile.config import CFG_WEBSEARCH_DEF_RECORDS_IN_GROUPS, \
...
from invenio.legacy.webauthorprofile.config import CFG_WEBAUTHORPROFILE_MAX_COLLAB_LIST, \
    ...
    def tmpl_authornametitle(self, authorname, bibauthorid_data, pubs, person_link, ln, loading=False):
        ...
        if loading:
            ...
            if person_link or person_link == 'None':
                menu = invenio.legacy.bibauthorid.templates.Template.tmpl_profile_navigation_bar(get_person_info_by_pid(bibauthorid_data['pid']), ln, "View Profile")
