...
<<<<<<< HEAD:invenio/legacy/webauthorprofile/webinterface.py
import datetime
import sys
...
from invenio.legacy.bibauthorid import webapi
...
from invenio.legacy.webpage import pageheaderonly, page
...
from invenio.legacy.webauthorprofile.config import CFG_SITE_LANG, CFG_SITE_URL, \
