...
<<<<<<< HEAD:invenio/legacy/search_engine/__init__.py
from invenio.legacy import bibrecord
from invenio.legacy.bibrecord import get_fieldvalues, get_fieldvalues_alephseq_like, record_exists
from invenio.legacy.bibrecord import create_record, record_xml_output
from invenio.legacy.bibrank.record_sorter import get_bibrank_methods, is_method_valid, rank_records as rank_records_bibrank, rank_by_citations
...
from invenio.utils.data_cacher import DataCacher
            ...
            if format == 'hp' or format.startswith("hb_") or format.startswith("hd_"):
                ...
                for recid in recIDs:
                    ...
                    if tab == 'usage':
                        ...
                        from invenio.utils import hepdatadisplay as hepdatadisplayutils
