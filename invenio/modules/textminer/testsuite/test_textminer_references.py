...
<<<<<<< HEAD:invenio/modules/textminer/testsuite/test_textminer_references.py
...
find_numeration = lazy_import('invenio.legacy.refextract.tag:find_numeration')
find_numeration_more = lazy_import('invenio.legacy.refextract.tag:find_numeration_more')
tag_arxiv = lazy_import('invenio.legacy.refextract.tag:tag_arxiv')
identify_ibids = lazy_import('invenio.legacy.refextract.tag:identify_ibids')
tag_numeration = lazy_import('invenio.legacy.refextract.tag:tag_numeration')
