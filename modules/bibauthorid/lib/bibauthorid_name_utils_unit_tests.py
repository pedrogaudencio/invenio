...
from invenio.legacy.bibauthorid.name_utils import split_name_parts, distance, create_canonical_name, create_normalized_name, create_unified_name, soft_compare_names
from invenio.legacy.bibauthorid.name_utils import full_names_are_equal_composites, full_names_are_substrings, surname_compatibility, initials_compatibility, compare_names
from invenio.legacy.bibauthorid.name_utils import create_name_tuples
